...
function TeacherOnboardingBridge() {
  ...
  return (
    <div className="space-y-6">
      <Card className="border-zinc-200 dark:border-zinc-800 shadow-xl rounded-[32px] overflow-hidden bg-white dark:bg-zinc-900">
        <CardHeader className="pb-2 pt-8 px-8 text-center">
          <div className="w-16 h-16 bg-violet-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <GraduationCap className="text-violet-600 w-8 h-8" />
          </div>
          <CardTitle className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Finish Account Setup</CardTitle>
        ...
        <CardContent className="p-8 pt-4 space-y-8">
          ...
          <div className="relative pl-10 border-l-2 border-violet-100 space-y-3 pb-4">
             ...
             <div>
                <h3 className="font-bold text-zinc-900 dark:text-zinc-100">Download Teacher App</h3>
          ...
          <div className="relative pl-10 border-l-2 border-transparent space-y-3">
             ...
             <div>
                <h3 className="font-bold text-zinc-900 dark:text-zinc-100">Setup My Account</h3>
          ...
          <div className="pt-4 text-center">
             <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest">
               Your Email: <span className="text-zinc-600 dark:text-zinc-400 underline">{emailParam}</span>
             </p>
          </div>
        </CardContent>
      </Card>
    ...
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Ayushman Educational Academy</p>
        </div>

        <Suspense fallback={
          <div className="flex justify-center p-20 bg-white dark:bg-zinc-900 rounded-[32px] border border-zinc-100 dark:border-zinc-800/50 shadow-xl">
